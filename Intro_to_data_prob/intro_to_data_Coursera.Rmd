...
sfo_feb_flights %>% summarise(n_sfo_feb_flights = n())
...
sfo_feb_flights %>% summarise(median_arr = median(arr_delay))
...
nycflights %>%filter(dep_type == "delayed") %>% summarise(ontime_prop  = sum(arr_type == "on time")/n())
